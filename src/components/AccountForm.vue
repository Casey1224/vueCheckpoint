    ...
    <form class="card account-form" @submit.prevent="handleSubmit">
        <div class="card-body text-start">
            ...
            <div>
                ...
                <textarea type="text" class="form-control" v-model="editable.email" required name="email" rows="8"
                    style="resize:none"></textarea>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" class="form-control" v-model="editable.subs" required name="subs">
            </div>
            <div>
